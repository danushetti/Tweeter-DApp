        ...
        <Avatar isRounded image={tweet.userImage} theme='image' size={60}/>
         <div className='completeTweet'>
            ...
            <div className='interactions'>
                <div className='interactionNums'><MessageCircle fontSize={20}/>o</div>
                <div className='interactionNums'><Calendar fontSize={20}/>{tweet.date}</div>
                {onlyUser? <div className='interactionNums'><Bin fontSize={20} color='#FF0000' onclick={() => null}/></div> : <div className='interactionNums'><Matic fontSize={20}/></div> }
